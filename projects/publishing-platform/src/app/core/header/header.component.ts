...
export class HeaderComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        if (isPlatformBrowser(this.platformId)) {
            ...
            this.subscriptions.add(
                this.accountService.loginSessionDataChanged.subscribe(() => {
                    // console.log('Login by method LoginSession');
                }
                ));

            this.subscriptions.add(
                this.accountService.showTagList$.subscribe(visibility => {
                    this.showTagList = visibility;
                }
                ));

            this.subscriptions.add(
                this.accountService.showSearchBar$.subscribe(
                    visibility => {
            ...
            this.subscriptions.add(this.accountService.logoutDataChanged.subscribe(
                () => {
                    this.account = null;
                    this.balance = null;
        ...
        this.subscriptions.add(
            this.articleService.articleEventEmitter.subscribe(
                data => {
