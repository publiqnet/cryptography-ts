...
import { Subject, Subscription, merge, zip } from 'rxjs';
...
export class NewcontentComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        if (isPlatformBrowser(this.platformId)) {
            ...
            this.subscriptions.add(
                this.articleService.listPromoByDsIdChanged.subscribe((data: Boost[]) => {
            ...
            this.subscriptions.add(
                this.articleService.addDraftDataChanged.subscribe(draft => {
                    this.hasDraft = true;
            ...
            this.subscriptions.add(
                this.articleService.updateDraftDataChanged.subscribe(draft => {
                    this.hasDraft = true;
                    const message = this.translateService.instant('content.draft_saved');
                    this.notificationService.autoSave(message);
                    this.draftUpdateDate = draft.lastModifiedDate;
            ...
            this.subscriptions.add(
                this.contentService.uploadMainPhotoDataChanged.subscribe(result => {
            ...
            this.subscriptions.add(
                this.contentService.uploadListPhotoDataChanged.subscribe(result => {
                    this.saveDraftCheck = true;
            ...
            this.subscriptions.add(this.articleService.deleteDraftDataChanged.subscribe());

            this.subscriptions.add(
                this.contentService.submittedContentChanged.subscribe(
                    data => {
            ...
            this.subscriptions.add(
                this.contentService.articleUpLoadingChanged.subscribe(
                    data => {
            ...
            this.subscriptions.add(
                this.accountService.accountUpdated$
                    ...
                    .subscribe(result => {
                        ...
                        this.translateService.get('content').subscribe(data => {
    ...
    openDialogSubmission() {
        ...
        if (!this.accountService.accountInfo.meta.first_name) {
            ...
            if (this.isArticleBoosted) {
                this.dialogService.openConfirmDialog(message).subscribe(done => {
                    if (done) {
    ...
    editCoverPhoto() {
        ...
        this.dialogService.openCoverEditDialog(editData).subscribe(responseData => {
