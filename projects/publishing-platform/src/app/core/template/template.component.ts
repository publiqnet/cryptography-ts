...
export class TemplateComponent implements OnInit, OnDestroy {
    ...
    notificationSubscription: Subscription = Subscription.EMPTY;
    hideFooterEventSubscription: Subscription = Subscription.EMPTY;
    ...
    ngOnInit() {
        if (isPlatformBrowser(this.platformId)) {
            ...
            this.hideFooterEventSubscription = this.contentService.hideFooter$.subscribe(visibility => this.hideFooter = visibility);
        }
    }
    ...
    ngOnDestroy() {
        if (isPlatformBrowser(this.platformId)) {
            ...
            this.hideFooterEventSubscription.unsubscribe();
