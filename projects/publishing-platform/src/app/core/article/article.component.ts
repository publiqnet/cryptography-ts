...
export class ArticleComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        if (isPlatformBrowser(this.platformId)) {
            ...
            this.subscriptions.add(
                this.contentService.feedbackChanged.subscribe(
                    feedback => {
            ...
            this.subscriptions.add(
                this.contentService.feedbackReportDataChanged.subscribe((feedbackReportData) => {
            ...
            this.subscriptions.add(
                this.contentService.feedbackLikeDataChanged.subscribe((feedbackReportData) => {
            ...
            this.subscriptions.add(
                this.articleService.getArticleByIdDataChanged.subscribe(data => {
                        if (data) {
                            this.article = data;
                            if (this.fullAccount) {
            ...
            this.subscriptions.add(
                this.articleService.getArticleHistoryByIdDataChanged.subscribe(data => {
                        if (data) {
                            const currentContent = this.historyList.find(
                                x => x.ds_id && x.ds_id == data._id
                            );
            ...
            this.subscriptions.add(
                this.articleService.articleTagsContentsDataChanged.subscribe(
                    (data: Content[]) => {
                        this.haveTags = false;
            ...
            this.subscriptions.add(
                this.articleService.articleAuthorContentsDataChanged.subscribe(
                    (data: Content[]) => {
            ...
            this.subscriptions.add(
                this.articleService.getContentHistoryDataChanged.subscribe(data => {
                        if (data) {
    ...
    public report() {
        ...
        this.dialogService.openReportDialog().subscribe(reasonId => {
