import { Component, ElementRef, Inject, Input, OnInit, PLATFORM_ID, SimpleChanges, ViewChild, Output, EventEmitter, OnChanges, OnDestroy } from '@angular/core';
            ...
            this.subscriptions.add(
                this.keyUp.pipe(
                    ...
                    if (text.length >= 3 && !SearchMemberComponent.validateEmail(text)) {
                        ...
                        this.accountService.searchAccount(text).subscribe((response: Account[]) => {
